...
**Checkpoint**: produto abre, carrega caso de referência e mostra perspectiva vazia nos 2 SOs; spike T062 com decisão GO registrada — **Windows ✅ (2026-06-11, caso `F:\test_yara_java21`)**; Linux pendente; **T062 é o único item restante da fase** (precisa de processamento rodando em paralelo)
